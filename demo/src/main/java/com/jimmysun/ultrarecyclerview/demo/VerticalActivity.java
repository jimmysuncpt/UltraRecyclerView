...
public class VerticalActivity extends AppCompatActivity {
    ...
    private int mAlignGravity = Gravity.START;
        ...
        findViewById(R.id.btn_apply).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mPagerSnapCheckBox.isChecked()) {
                    ...
                    mUltraRecyclerView.setPagerSnap(mAlignGravity, margin);
                } else {
                    mUltraRecyclerView.setPagerSnap(Gravity.NO_GRAVITY);
                }
                mUltraRecyclerView.setInfiniteLoop(mInfiniteCheckBox.isChecked());
                if (mAutoScrollCheckBox.isChecked()) {
                    ...
                    mUltraRecyclerView.setAutoScrollSpeed(speed);
                } else {
